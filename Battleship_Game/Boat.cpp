...
Boat::Boat() : BOATCOUNT(4), HORIZONTAL(90), VERTICAL(180), MARGIN(50), STARTED(1)
{
	...
	textureRect.push_back(sf::IntRect(89, 36, 21, 108));
	textureRect.push_back(sf::IntRect(128, 88, 23, 57));
	textureRect.push_back(sf::IntRect(61, 57, 23, 87));
	textureRect.push_back(sf::IntRect(0, 0, 26, 147));

	//EXPLOSION
	explosionTexture.loadFromFile("Resources/Boats.png");
	explosion.setTexture(explosionTexture);
	explosion.setTextureRect(sf::IntRect(74, 2, 32, 29));
	...
	playedCase.setTextureRect(sf::IntRect(35, 1, 33, 33));
